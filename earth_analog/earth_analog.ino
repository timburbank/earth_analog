...
void loop() {
  ...
  //// linearize input value as per 
  //// http://forum.arduino.cc/index.php?PHPSESSID=jchuis6q5f4pburbetor3rnc34&topic=17327.msg126344#msg126344
  //// nevermind, this makes it worse
//  pot_val_lin = (long)((log((float)pot_val) / log(POT_LOG_TYPE)) * POT_LOG_SCALE);
//  Serial.println(pot_val_lin);
//  delay(1);
